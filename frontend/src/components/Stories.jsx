      ...
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div
            ...
            key={index}
            className="relative rounded-lg shadow min-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-linear-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 scrollbar-none"
          >
            <img
              src={story.story_image}
              alt=""
              className="absolute top-3 left-3 w-8 h-8 rounded-full ring-2 ring-white object-cover z-10"
            />
